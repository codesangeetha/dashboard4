...
export default function CheckoutDress() {
    ...
    function placeorderFn() {
        if (validateForm()) {
            ...
            postData(url, postObj)
                .then(async data => {
                    localStorage.removeItem("basketid-dress");
                    navigate(`/placeorderdress`);
                });
        ...
        <div>
            ...
            <div className="display-class">
                ...
                <div >
                    ...
                    <div className="marginTop-class">
                        <input type="text" placeholder="State" value={addressdata.state} name="state" onChange={handleChange} />
